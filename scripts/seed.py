...
def seed():
    ...
    seed_roles(db)
    create_user(db, "Alex Owner", "owner", pin="0000", email="owner@demo.restaurant")
    create_user(db, "Sam Manager", "manager", pin="1111", email="manager@demo.restaurant")
    create_user(db, "Jordan Kitchen", "kitchen", pin="2222")
    create_user(db, "Casey Server", "server", pin="3333")
